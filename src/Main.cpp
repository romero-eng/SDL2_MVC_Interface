...
int main( int argc, char* args[] )
{
	...
	try {
		...
		const auto& [arrow_boundary_points, arrow_within_boundary_points] = Graphics::Shape::calculate_polygon_points(calculate_arrow_vertex_points(W_r, W_t, H_r, H_t, arrow_center, angle_degrees));
		...
		const auto& [circle_boundary_points, circle_within_boundary_points] = Graphics::Shape::calculate_circle_points(radius, circle_center.round());
		paintbrush.SetDrawingColor(RED);
